...
# ================================================================================
resource "aws_api_gateway_rest_api" "techfood_api" {
...
resource "aws_api_gateway_resource" "api_resource" {
  rest_api_id = aws_api_gateway_rest_api.techfood_api.id
  parent_id   = aws_api_gateway_rest_api.techfood_api.root_resource_id
  path_part   = "api"
}
...
resource "aws_api_gateway_integration" "proxy_integration" {
  ...
  uri                     = "http://${aws_lb.techfood_nlb.dns_name}/{proxy}"
  connection_type         = "VPC_LINK"
  connection_id           = aws_api_gateway_vpc_link.techfood_vpc_link.id
...
resource "aws_api_gateway_integration" "api_integration" {
  ...
  type                    = "HTTP_PROXY"
  integration_http_method = "ANY"
  uri                     = "http://${aws_lb.techfood_nlb.dns_name}/"
  connection_type         = "VPC_LINK"
  connection_id           = aws_api_gateway_vpc_link.techfood_vpc_link.id
}
